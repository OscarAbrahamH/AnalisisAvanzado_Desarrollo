...
| Nombre |[Sistema Sensorial]|
| Detalle |[El sistema debera tener compatibilidad con el sistema sensorial para poder realizar el monitoreo de humedad, temperatura e iluminacion]|
...
| Nombre |[Sistema Adaptado]|
| Detalle |[El sistema debera contar con compatibilidad con diferentes puntos de acceso tanto como web y movil para asi ofrecer al usuario una forma flexible de acceso]|

|:pencil: Requisito  | Descripción |
|:---|:---|
| Identificador |[RNF-05]|
| Nombre |[Funcionalidad del Sistema]|
| Detalle |[El sistema debe ser capaz de captar y almacenar los parametros solicitados para la correcta medicion y control de las areas o espacios a monitoriear.]|
...
:house: [Ir a Github](https://github.com/OscarAbrahamH/AnalisisAvanzado_Desarrollo/blob/master/AbrahamHDocs/blog/C2.2_OscarHuerta_Zeppelin.md)